...
namespace SwiftBookingTest.Model.Extension
{
    public static class CoreExtensions
    {
        ...
        public static bool IsNavigable(this BaseClass obj, string propertyName)
        {
            PropertyInfo propertyInfo = obj.GetType().GetProperty(propertyName);
            return propertyInfo.IsNavigable();
        }

        public static bool IsNavigable<T>(this BaseClass obj, Expression<Func<T>> propertyExpression)
        {
        ...
        public static PropertyInfo[] GetBrowsableProperties(this object obj)
        {
            ...
            if (!BrowsablePropertyInfos.ContainsKey(key))
            {
                ...
                {
                    if ((property.PropertyType.IsSubclassOf(typeof(BaseClass)) || property.PropertyType.GetInterface("IList") != null))
                    {
