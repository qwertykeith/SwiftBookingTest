...
intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax requestDto. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) requestDto.</summary>
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax requestDto. All settings are optional. A default can be set for any option with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'ajaxSetup': function() {
    ...
    ///   <param name="options" type="Object">A set of key/value pairs that configure the default Ajax requestDto. All options are optional.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'get': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the requestDto is sent.</param>
    ///   <param name="data" type="String">A map or string that is sent to the server with the requestDto.</param>
  ...
  'getJSON': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the requestDto is sent.</param>
    ///   <param name="data" type="Object">A map or string that is sent to the server with the requestDto.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the requestDto succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
